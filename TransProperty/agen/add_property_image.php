...
if(isset($submit))
{
  ...
  move_uploaded_file($_FILES['file1']['tmp_name'],"../admin/images/property_image/".$_FILES['file1']['name']); 
  move_uploaded_file($_FILES['file2']['tmp_name'],"../admin/images/property_image/".$_FILES['file2']['name']); 
  move_uploaded_file($_FILES['file3']['tmp_name'],"../admin/images/property_image/".$_FILES['file3']['name']); 
                ...
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="card">
                        <div class="header">
                            ...
                            <a class="btn btn-info" href="add_property.php">Kembali</a>
                        </div>
                        <div class="body">
