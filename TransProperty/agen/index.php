...
if(isset($save))
{
$que=mysqli_query($con,"select * from agent where email='$email' && password='$pass'");	
$row=mysqli_num_rows($que);
if($row)
{
$_SESSION['email']=$email;
header('location:page/properties.php');
}	
else
{
 ...
 <?php echo @$msg;?>
  ...
  <div class="container">
    <div class="card card-login mx-auto mt-5">
      ...
      <div><p>Belum Punya Akun Agent?<a href="register.php">Register</a></p></div>
		</form>
